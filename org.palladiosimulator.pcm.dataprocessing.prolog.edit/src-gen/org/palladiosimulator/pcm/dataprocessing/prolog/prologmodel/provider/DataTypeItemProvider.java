...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.dataprocessing.prolog.prologmodel.DataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType_attributes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType_attributes_feature", "_UI_DataType_type"),
				 PrologmodelPackage.Literals.DATA_TYPE__ATTRIBUTES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PrologmodelPackage.Literals.DATA_TYPE__NAME,
				 true,
				 false,
				 false,
