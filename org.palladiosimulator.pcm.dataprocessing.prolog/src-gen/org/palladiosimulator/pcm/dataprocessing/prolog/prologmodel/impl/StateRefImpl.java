 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.dataprocessing.prolog.prologmodel.impl.StateRefImpl#getStateVariable <em>State Variable</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.dataprocessing.prolog.prologmodel.impl.StateRefImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.dataprocessing.prolog.prologmodel.impl.StateRefImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateRefImpl extends LogicTermImpl implements StateRef
{
	...
	{
		return PrologmodelPackage.Literals.STATE_REF;
	}
		...
		if (stateVariable != null && stateVariable.eIsProxy())
		{
			...
			if (stateVariable != oldStateVariable)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PrologmodelPackage.STATE_REF__STATE_VARIABLE, oldStateVariable, stateVariable));
			}
		}
	...
	public void setStateVariable(Variable newStateVariable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrologmodelPackage.STATE_REF__STATE_VARIABLE, oldStateVariable, stateVariable));
	}
	...
	public Attribute getAttribute()
	{
		if (attribute != null && attribute.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PrologmodelPackage.STATE_REF__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public void setAttribute(Attribute newAttribute)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrologmodelPackage.STATE_REF__ATTRIBUTE, oldAttribute, attribute));
	}
	...
	public Value getValue()
	{
		if (value != null && value.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PrologmodelPackage.STATE_REF__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(Value newValue)
	{
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrologmodelPackage.STATE_REF__VALUE, oldValue, value));
	}
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate GET_POSSIBLE_VARIABLES__EINVOCATION_DELEGATE = ((EOperation.Internal)PrologmodelPackage.Literals.STATE_REF___GET_POSSIBLE_VARIABLES).getInvocationDelegate();
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate GET_POSSIBLE_ATTRIBUTES__EINVOCATION_DELEGATE = ((EOperation.Internal)PrologmodelPackage.Literals.STATE_REF___GET_POSSIBLE_ATTRIBUTES).getInvocationDelegate();
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate GET_POSSIBLE_VALUES__EINVOCATION_DELEGATE = ((EOperation.Internal)PrologmodelPackage.Literals.STATE_REF___GET_POSSIBLE_VALUES).getInvocationDelegate();
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate IS_ATTRIBUTE_WILDCARD__EINVOCATION_DELEGATE = ((EOperation.Internal)PrologmodelPackage.Literals.STATE_REF___IS_ATTRIBUTE_WILDCARD).getInvocationDelegate();
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate IS_VALUE_WILDCARD__EINVOCATION_DELEGATE = ((EOperation.Internal)PrologmodelPackage.Literals.STATE_REF___IS_VALUE_WILDCARD).getInvocationDelegate();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case PrologmodelPackage.STATE_REF__CONTAINING_ASSIGNMENT:
				if (resolve) return getContainingAssignment();
				return basicGetContainingAssignment();
			case PrologmodelPackage.STATE_REF__STATE_VARIABLE:
				if (resolve) return getStateVariable();
				return basicGetStateVariable();
			case PrologmodelPackage.STATE_REF__ATTRIBUTE:
				if (resolve) return getAttribute();
				return basicGetAttribute();
			case PrologmodelPackage.STATE_REF__VALUE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			case PrologmodelPackage.STATE_REF___GET_POSSIBLE_VARIABLES:
				return getPossibleVariables();
			case PrologmodelPackage.STATE_REF___GET_POSSIBLE_ATTRIBUTES:
				return getPossibleAttributes();
			case PrologmodelPackage.STATE_REF___GET_POSSIBLE_VALUES:
				return getPossibleValues();
			case PrologmodelPackage.STATE_REF___IS_ATTRIBUTE_WILDCARD:
				return isAttributeWildcard();
			case PrologmodelPackage.STATE_REF___IS_VALUE_WILDCARD:
