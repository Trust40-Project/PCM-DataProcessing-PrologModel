...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.dataprocessing.prolog.prologmodel.OperationCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationCall_callee_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationCall_callee_feature", "_UI_OperationCall_type"),
				 PrologmodelPackage.Literals.OPERATION_CALL__CALLEE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationCall_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationCall_name_feature", "_UI_OperationCall_type"),
				 PrologmodelPackage.Literals.OPERATION_CALL__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(PrologmodelPackage.Literals.OPERATION_CALL__PARAMETER_ASSIGNMENTS);
			childrenFeatures.add(PrologmodelPackage.Literals.OPERATION_CALL__PRE_CALL_STATE_DEFINITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(PrologmodelPackage.Literals.OPERATION_CALL__PARAMETER_ASSIGNMENTS,
				 PrologmodelFactory.eINSTANCE.createVariableAssignment()));

		newChildDescriptors.add
			(createChildParameter
				(PrologmodelPackage.Literals.OPERATION_CALL__PRE_CALL_STATE_DEFINITIONS,
				 PrologmodelFactory.eINSTANCE.createVariableAssignment()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
	{
		...
		boolean qualify =
			childFeature == PrologmodelPackage.Literals.OPERATION_CALL__PARAMETER_ASSIGNMENTS ||
			childFeature == PrologmodelPackage.Literals.OPERATION_CALL__PRE_CALL_STATE_DEFINITIONS;
