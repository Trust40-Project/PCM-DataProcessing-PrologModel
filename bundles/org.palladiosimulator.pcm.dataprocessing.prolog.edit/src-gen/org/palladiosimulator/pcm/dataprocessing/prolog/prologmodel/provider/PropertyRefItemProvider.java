...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.dataprocessing.prolog.prologmodel.PropertyRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyRef_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyRef_operation_feature", "_UI_PropertyRef_type"),
				 PrologmodelPackage.Literals.PROPERTY_REF__OPERATION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PrologmodelPackage.Literals.PROPERTY_REF__VALUE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PrologmodelPackage.Literals.PROPERTY_REF__PROPERTY,
				 true,
				 false,
				 true,
				 null,
