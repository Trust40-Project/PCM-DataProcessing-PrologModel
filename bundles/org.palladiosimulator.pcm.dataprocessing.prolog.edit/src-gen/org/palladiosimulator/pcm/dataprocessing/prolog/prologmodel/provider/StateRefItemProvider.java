...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.dataprocessing.prolog.prologmodel.StateRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateRefItemProvider extends LogicTermItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StateRef_stateVariable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StateRef_stateVariable_feature", "_UI_StateRef_type"),
				 PrologmodelPackage.Literals.STATE_REF__STATE_VARIABLE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_StateRef_attribute_feature", "_UI_StateRef_type"),
				 PrologmodelPackage.Literals.STATE_REF__ATTRIBUTE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PrologmodelPackage.Literals.STATE_REF__VALUE,
				 true,
				 false,
				 true,
				 null,
	...
	{
		return getString("_UI_StateRef_type");
	}
