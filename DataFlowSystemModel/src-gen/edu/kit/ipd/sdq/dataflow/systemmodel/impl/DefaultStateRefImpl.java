 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.dataflow.systemmodel.impl.DefaultStateRefImpl#getStateVariable <em>State Variable</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.dataflow.systemmodel.impl.DefaultStateRefImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.dataflow.systemmodel.impl.DefaultStateRefImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefaultStateRefImpl extends LogicTermImpl implements DefaultStateRef {
	...
	protected EClass eStaticClass() {
		return SystemModelPackage.Literals.DEFAULT_STATE_REF;
	}
			...
			if (stateVariable != oldStateVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SystemModelPackage.DEFAULT_STATE_REF__STATE_VARIABLE, oldStateVariable, stateVariable));
			}
		}
	...
	public void setStateVariable(Variable newStateVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemModelPackage.DEFAULT_STATE_REF__STATE_VARIABLE,
	...
	public Attribute getAttribute() {
		if (attribute != null && attribute.eIsProxy()) {
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SystemModelPackage.DEFAULT_STATE_REF__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public void setAttribute(Attribute newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemModelPackage.DEFAULT_STATE_REF__ATTRIBUTE,
	...
	public Value getValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SystemModelPackage.DEFAULT_STATE_REF__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(Value newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemModelPackage.DEFAULT_STATE_REF__VALUE, oldValue,
					value));
	}
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate GET_POSSIBLE_VARIABLES__EINVOCATION_DELEGATE = ((EOperation.Internal) SystemModelPackage.Literals.DEFAULT_STATE_REF___GET_POSSIBLE_VARIABLES)
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate GET_POSSIBLE_ATTRIBUTES__EINVOCATION_DELEGATE = ((EOperation.Internal) SystemModelPackage.Literals.DEFAULT_STATE_REF___GET_POSSIBLE_ATTRIBUTES)
			.getInvocationDelegate();
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate GET_POSSIBLE_VALUES__EINVOCATION_DELEGATE = ((EOperation.Internal) SystemModelPackage.Literals.DEFAULT_STATE_REF___GET_POSSIBLE_VALUES)
			.getInvocationDelegate();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SystemModelPackage.DEFAULT_STATE_REF__STATE_VARIABLE:
			if (resolve)
				return getStateVariable();
			return basicGetStateVariable();
		case SystemModelPackage.DEFAULT_STATE_REF__ATTRIBUTE:
			if (resolve)
				return getAttribute();
			return basicGetAttribute();
		case SystemModelPackage.DEFAULT_STATE_REF__VALUE:
			if (resolve)
				return getValue();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case SystemModelPackage.DEFAULT_STATE_REF___GET_POSSIBLE_VARIABLES:
			return getPossibleVariables();
		case SystemModelPackage.DEFAULT_STATE_REF___GET_POSSIBLE_ATTRIBUTES:
