 ...
 *   <li>{@link edu.kit.ipd.sdq.dataflow.systemmodel.impl.CallerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CallerImpl extends MinimalEObjectImpl.Container implements Caller {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemModelPackage.CALLER__NAME, oldName, name));
	}
