 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.dataflow.systemmodel.And#getFirstOperand <em>First Operand</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.dataflow.systemmodel.And#getSecondOperand <em>Second Operand</em>}</li>
 * </ul>
 *
...
public interface And extends LogicTerm {
	 ...
	 * @see edu.kit.ipd.sdq.dataflow.systemmodel.SystemModelPackage#getAnd_FirstOperand()
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.dataflow.systemmodel.And#getFirstOperand <em>First Operand</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.kit.ipd.sdq.dataflow.systemmodel.SystemModelPackage#getAnd_SecondOperand()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.dataflow.systemmodel.And#getSecondOperand <em>Second Operand</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
