 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.dataflow.systemmodel.impl.AndImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndImpl extends LogicTermImpl implements And {
	...
	public EList<LogicTerm> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<LogicTerm>(LogicTerm.class, this, SystemModelPackage.AND__OPERANDS);
		}
		return operands;
	}
